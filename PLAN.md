...
- [x] **1a. Update `onClick` in `index.tsx`:**
...
- [x] **1b. Add regression test in `index.test.tsx`:**
...
- [x] **1c. Add regression test for interactive target:**
...
- [x] **2a. Add `variant` and `position` props to `SkipLinkProps` in `index.tsx`:**
...
- [x] **2b. Add `.SkipLink--inline` styles in `skip-link.css`:**
...
- [x] **2c. Add tests for the inline variant in `index.test.tsx`:**
...
- [x] **2d. Update documentation in `SkipLink.mdx`:**
...
- [x] **3a.** Run SkipLink tests: `yarn --cwd=packages/react test SkipLink`
- [x] **3b.** Run full test suite: `yarn test`
- [x] **3c.** Run lint: `yarn lint`
