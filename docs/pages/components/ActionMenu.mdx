...
```jsx
import { ActionMenu, ActionList, ActionListItem } from '@deque/cauldron-react';
```
...
```jsx example
<ActionMenu
  trigger={<IconButton variant="secondary" icon="kabob" label="More Options" />}
>
  <ActionList>
    <ActionListItem>Copy</ActionListItem>
    <ActionListItem>Edit</ActionListItem>
...
```jsx example
<ActionMenu trigger={<Button variant="secondary">Choose a Dessert</Button>}>
  <ActionList>
    <ActionListItem description="Warm chocolate cake with a gooey center that oozes when you dig in">
      Molten Lava Cake
    </ActionListItem>
    <ActionListItem description="Crispy on the outside, chewy in the middle, with melted chocolate chips">
      Cookie Sundae
    </ActionListItem>
    <ActionListItem description="Tangy, creamy cheesecake swirled with tart raspberry sauce">
...
>
  <ActionList>
    ...
    <ActionListItem leadingIcon="trash" variant="danger">
      Delete
    </ActionListItem>
  </ActionList>
</ActionMenu>
...
function ActionMenuListCallbackExample() {
  ...
  return (
    <ActionMenu
      trigger={<Button variant="secondary">Action list handler</Button>}
    >
...
function ActionMenuListActionKeyCallbackExample() {
  ...
  return (
    <ActionMenu
      trigger={<Button variant="secondary">Action key handler</Button>}
    >
      <ActionList onAction={handleAction}>
  ...
  return (
    ...
    >
      <ActionList selectionType="single" onAction={handleAction}>
        <ActionListItem selected={selected === 'Really Small'}>
          Really Small
        </ActionListItem>
        ...
        <ActionListItem selected={selected === 'Super Large'}>
          Super Large
        </ActionListItem>
      </ActionList>
    </ActionMenu>
    ...
    >
      <ActionList selectionType="multiple" onAction={handleAction}>
        <ActionListGroup label="Protein">
          <ActionListItem selected={selected.includes('Bacon')}>
            Bacon
          </ActionListItem>
          <ActionListItem selected={selected.includes('Ham')}>
            Ham
          </ActionListItem>
          <ActionListItem selected={selected.includes('Turkey')}>
            Turkey
          </ActionListItem>
          <ActionListItem selected={selected.includes('Tofurky')}>
            Tofurky
          </ActionListItem>
        </ActionListGroup>
        <ActionListGroup label="Cheese">
          <ActionListItem selected={selected.includes('Gruyere')}>
            Gruyere
          </ActionListItem>
          <ActionListItem selected={selected.includes('Gouda')}>
            Gouda
          </ActionListItem>
          <ActionListItem selected={selected.includes('Pepperjack')}>
            Pepperjack
          </ActionListItem>
          <ActionListItem selected={selected.includes('Swiss')}>
            Swiss
          </ActionListItem>
        </ActionListGroup>
        <ActionListItem selected={selected.includes('Lettuce')}>
          Lettuce
        </ActionListItem>
        <ActionListItem selected={selected.includes('Tomato')}>
          Tomato
        </ActionListItem>
        <ActionListItem selected={selected.includes('Onions')}>
          Onions
        </ActionListItem>
      </ActionList>
    </ActionMenu>
  ...
  return (
    ...
    >
      <ActionList selectionType="multiple">
        ...
        >
          <ActionListItem selected={difficulty === 'Standard'}>
            Standard
          </ActionListItem>
          <ActionListItem selected={difficulty === 'Normal'}>
            Normal
          </ActionListItem>
          <ActionListItem selected={difficulty === 'Expert'}>
            Expert
          </ActionListItem>
        </ActionListGroup>
        <ActionListGroup label="Allowed Fruit" onAction={handleColorsAction}>
          <ActionListItem selected={colors.includes('Apple')}>
            Apple
          </ActionListItem>
          <ActionListItem selected={colors.includes('Banana')}>
            Banana
          </ActionListItem>
          <ActionListItem selected={colors.includes('Orange')}>
            Orange
          </ActionListItem>
          <ActionListItem selected={colors.includes('Pineapple')}>
            Pineapple
          </ActionListItem>
        </ActionListGroup>
      </ActionList>
...
With `renderInTrigger`, the menu is rendered _inside_ the trigger. Roles like `menuitem` take their accessible name from their content, so the trigger would otherwise be named after every item in the menu it contains. Wrap the trigger's visible label in an element carrying the `labelId` passed to the trigger function — `ActionMenu` points both the trigger and the menu at it. Destructure `labelId` out of the props so it is not spread onto a DOM element:
  ...
  props={[
    {
      ...
      required: true,
      description:
        'The ActionList component to be shown when the menu is opened.'
    },
    {
      name: 'trigger',
      type: [
      ...
      required: true,
      description:
        'Element that triggers the menu to open. Can be a React element or a render function that receives props and the current open state. The trigger element type defaults to HTMLButtonElement; when nesting inside a TopBar/MenuBar, annotate the trigger param (e.g. (props: ActionMenuTriggerProps<HTMLLIElement>) => …) so the trigger ref and handlers type against the actual element without casts. Render functions also receive a labelId, which must be placed on the element wrapping the trigger’s visible label when renderInTrigger is set.'
    },
    {
      name: 'renderInTrigger',
      type: 'boolean',
      defaultValue: 'false',
      description:
        'Renders the menu as a child of the trigger rather than as a sibling. Intended for nested menu patterns, for example an ActionMenu inside a TopBar/MenuBar. Requires a trigger render function that places labelId on the trigger’s label element, and is incompatible with portal.'
    },
    {
      name: 'placement',
      type: 'string',
    ...
    },
    {
      ...
      type: 'boolean',
      description:
        'Controls whether the action menu is open. Only necessary for controlling action menu state.'
    },
    {
      name: 'portal',
