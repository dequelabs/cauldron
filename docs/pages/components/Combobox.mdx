...
function ComboboxControlledExample() {
  ...
  const handleSelectionChange = ({ value, previousValue }) => {
    setValue(value);
  };
  return (
    <FieldWrap>
...
```jsx example
function ComboboxWithOptionsMultiselectExample() {
...
### Multiselect With Children

```jsx example
function ComboboxWithChildrenMultiselectExample() {
  const [inputValue, setInputValue] = useState('');
  const [value, setValue] = useState([]);
...
<ComponentProps className={true} refType="HTMLDivElement" props={[
  ...
  },
  {
    name: 'inputValue',
    type: 'string',
    description: 'Initial value to be applied to the combobox input field. Optionally used for "uncontrolled" comboboxes.'
  },
  {
    name: 'value',
    type: ['string', 'string[]'],
  ...
  },
  {
    ...
    type: 'boolean',
    defaultValue: 'false',
    description: 'Sets the combobox to multiselect mode.'
  },
  {
    name: 'onChange',
    type: 'function',
