...
<Note>
  Listbox follows [aria
  practices](https://www.w3.org/WAI/ARIA/apg/patterns/listbox/) for _Listbox_
  but is not currently intended to be used by itself. This component's intended
  usage is to be composed with components that have keyboard-navigable items
  like [Combobox](./Combobox) and [OptionsMenu](./OptionsMenu).
</Note>
...
<Note>
  Multiselect Listbox components will pass in array values for the selected
  ...
  props={[
    {
      ...
      type: ['string', 'number'],
      description:
        'Value to be applied to the listbox. Optionally used for "controlled" listboxes.'
    },
    {
      name: 'defaultValue',
      type: ['string', 'number'],
      description:
        'Initial value to be applied to the listbox. Optionally used for "uncontrolled" listboxes.'
    },
    {
    ...
    },
    {
      ...
      defaultValue: 'bound',
      description:
        'How keyboard navigation is handled when reaching the start/end of the list.'
    },
    {
      name: 'focusStrategy',
      ...
      description:
        'How focus is handled when the listbox becomes focused and which listbox option is active.'
    },
    {
      name: 'focusDisabledOptions',
      type: 'boolean',
      description:
        'Whether or not to allow for focusing of disabled listbox options.'
    },
    {
      name: 'activeOption',
      type: 'Object',
      description:
        'Used to control the active option within the listbox. Used for advanced behaviors.'
    },
    {
      name: 'as',
  ...
  props={[
    {
      ...
      type: ['string', 'number'],
      description:
        'Value to be applied to the listbox option. When omitted, value will default to the text content of the option.'
    },
    {
      name: 'disabled',
      type: 'boolean',
      description:
        'When set, sets the listbox option as "aria-disabled="true" and removes the element from key navigation.'
    },
    {
      name: 'selected',
      type: 'boolean',
    ...
    },
    {
      ...
      description:
        'When the listbox option becomes active, this class will be applied to the element.'
    },
    {
      name: 'as',
      type: ['React.ElementType', 'string'],
