...
Ellipsis can be applied to truncated text without showing the full text upon an additional interaction on the page, however this should _only_ be used if you know what you are doing and generally should be avoided.
