...
<Note>
  ...
  <a href="/components/Notice#notice-with-composed-contents">example</a>).
</Note>
...
<Notice type="info">
  <div
    ...
    style={{ display: 'inline-flex', gap: 'var(--space-half)', justifyContent: 'center', alignItems: 'center' }}
  >
  <Icon type="info-circle-alt" />
    <span>A new update has been released!</span>
  </div>
</Notice>
