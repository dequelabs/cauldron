...
<Note>
  The `selectionType` property is important depending on which selection states are needed, as this controls the underlying aria properties that is communicated for users who use assistive technology.
</Note>
...
<ComponentProps
  ...
  props={[
    ...
    },
    {
      name: 'leadingIcon',
      type: 'string',
      description: 'Displays a leading for the action item. '
    },
    {
      name: 'trailingIcon',
      type: 'string',
      description: 'Displays a trailing for the action item. '
    },
    {
      name: 'selected',
      type: 'boolean',
