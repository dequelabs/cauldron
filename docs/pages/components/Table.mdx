...
<Table>
  <TableHead>
    <TableRow>
      <TableHeader scope="col" align="end" width="1fr">First Name</TableHeader>
      <TableHeader scope="col" width="1fr">Last Name</TableHeader>
      <TableHeader scope="col" width="max-content">Email</TableHeader>
    </TableRow>
  </TableHead>
  <TableBody>
    <TableRow>
