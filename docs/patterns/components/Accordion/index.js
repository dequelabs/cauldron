      ...
      <div>
        <div className="Demo data-list-demo">
          ...
          <p>
            ...
            thumbnail representing a section of content. The headings function
            as controls that enable users to reveal or hide their associated
            sections of content. Accordions are commonly used to reduce the need
            to scroll when presenting multiple sections of content on a single
            page."
          </p>
          <h2>Try it out</h2>
          <h3>Standard</h3>
